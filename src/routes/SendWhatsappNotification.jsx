...
export default function SendWhatsappNotification() {
  ...
  const sendToBackend = async () => {
    try {
      const response = await axios.post(
        "http://localhost:5000/v1/notification/whatsapp",
        {
          data: {
            content: {
              subject: subject,
  ...
  return (
    <>
      <h1 className="text-4xl font-bold mb-3  p-6">Whatsapp Notification</h1>
