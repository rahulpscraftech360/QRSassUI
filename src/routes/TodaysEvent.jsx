...
const TodaysEvent = () => {
  ...
  return (
    <main className=" md:pl-24 flex flex-1 flex-col  gap-4 p-4 md:gap-8 md:p-6 ">
      <div className="flex items-center ">
        <h1 className="font-semibold text-lg md:text-2xl">Todays Events</h1>
      ...
      <Card>
        <CardContent className="p-0">
          {TodaysEvents && (
            ...
            //   </TableBody>
            // </Table>
            <EventTable events={TodaysEvents} />
          )}
          {/* <Table>
            <TableHeader>
              <TableRow>
