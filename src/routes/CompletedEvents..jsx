...
const CompletedEvents = () => {
  ...
  return (
    <main className=" md:pl-16 flex flex-1 flex-col  gap-4 p-4 md:gap-8 md:p-6">
      <div className="flex items-center ">
        <h1 className="font-semibold text-lg md:text-2xl">Completed Events</h1>
      ...
      <Card>
        <CardContent className="p-0">
          {completedEvents && (
            ...
            //   </TableBody>
            // </Table>
            <EventTable events={completedEvents} />
          )}
          {/* <Table>
            <TableHeader>
              <TableRow>
